...
export default function Page() {
  ...
  const controlSections = [
    ...
    { 
      ...
      docTitle: "СН 1.03.01-2019 Возведение строительных конструкций зданий и сооружений", 
      id: "monolit", 
      icon: Layers, 
      hasDoc: true, 
      description: "Требования к опалубочным, арматурным и бетонным работам при возведении монолитных железобетонных конструкций." 
    },
